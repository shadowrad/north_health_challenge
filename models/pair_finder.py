...
class PairFinder:
    ...
    def find_pairs_with_equal_sum(self, minimum_required_pairs: int = 1) -> Dict[int, Set[Tuple[int, int]]]:
        ...
        return {s: pairs for s, pairs in self.sum_map.items() if len(pairs) >= minimum_required_pairs}
